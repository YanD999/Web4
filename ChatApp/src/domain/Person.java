...
public class Person {
	...
	private String userId, password, salt, firstName, lastName, status;
	private Role role;
	...
	public void setUserId(String userId) {
		if (userId.isEmpty()) throw new IllegalArgumentException("No id given");
	...
	public boolean isCorrectPassword(String password) {
		if (password.trim().isEmpty()) throw new IllegalArgumentException("No password given");
	...
	public void setFirstName(String firstName) {
		if (firstName.trim().isEmpty()) throw new IllegalArgumentException("No firstname given");
	...
	public void setLastName(String lastName) {
		if (lastName.trim().isEmpty()) throw new IllegalArgumentException("No last name given");
